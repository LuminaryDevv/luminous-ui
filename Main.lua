...
local BuiltInThemes = {
	...
	Gold = {
		Primary = Color3.fromRGB(45, 35, 20),
		Secondary = Color3.fromRGB(65, 50, 28),
		Component = Color3.fromRGB(85, 65, 38),
		Interactables = Color3.fromRGB(115, 85, 48),
		Tab = Color3.fromRGB(255, 215, 0),
		Title = Color3.fromRGB(255, 235, 120),
		Description = Color3.fromRGB(220, 185, 80),
		Shadow = Color3.fromRGB(0, 0, 0),
		Outline = Color3.fromRGB(180, 135, 45),
		Icon = Color3.fromRGB(255, 200, 50),
	},
	DeepSea = {
	...
	Galaxy = {
		Primary = Color3.fromRGB(8, 6, 25),
		Secondary = Color3.fromRGB(25, 12, 45),
		Component = Color3.fromRGB(40, 18, 65),
		Interactables = Color3.fromRGB(65, 35, 100),
		Tab = Color3.fromRGB(255, 120, 200),
		Title = Color3.fromRGB(220, 160, 255),
		Description = Color3.fromRGB(160, 120, 210),
		Shadow = Color3.fromRGB(0, 0, 0),
		Outline = Color3.fromRGB(120, 80, 180),
		Icon = Color3.fromRGB(255, 100, 200),
	},
	Amethyst = {
		Primary = Color3.fromRGB(45, 35, 65),
		Secondary = Color3.fromRGB(60, 45, 85),
		Component = Color3.fromRGB(75, 55, 105),
		Interactables = Color3.fromRGB(100, 75, 135),
		Tab = Color3.fromRGB(200, 150, 255),
		Title = Color3.fromRGB(230, 200, 255),
		Description = Color3.fromRGB(180, 140, 220),
		Shadow = Color3.fromRGB(0, 0, 0),
		Outline = Color3.fromRGB(110, 80, 150),
		Icon = Color3.fromRGB(210, 140, 255),
	},
	Topaz = {
	...
	Violet = {
		Primary = Color3.fromRGB(55, 35, 85),
		Secondary = Color3.fromRGB(75, 50, 110),
		Component = Color3.fromRGB(95, 70, 130),
		Interactables = Color3.fromRGB(125, 95, 160),
		Tab = Color3.fromRGB(215, 150, 255),
		Title = Color3.fromRGB(235, 190, 255),
		Description = Color3.fromRGB(185, 140, 220),
		Shadow = Color3.fromRGB(0, 0, 0),
		Outline = Color3.fromRGB(115, 75, 155),
		Icon = Color3.fromRGB(220, 140, 255),
	},
}
